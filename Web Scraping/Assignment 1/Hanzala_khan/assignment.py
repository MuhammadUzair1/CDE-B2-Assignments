...
while condition:
    ...
    for url , filename in urls:
        ...
        if match:
            ...
            elif filename == 'Action & Adventure_books.csv':
        ...
        if filename == 'thriller_books.csv':
            urls.clear()
            urls.append(('https://www.thriftbooks.com/browse/?11853col#b.s=mostPopular-desc&b.p=1&b.pp=50&b.col&b.f.t%5B%5D=11853&b.list', 'Action & Adventure_books.csv'))
            continue
        elif urls[0][1] == 'Action & Adventure_books.csv':
            print(urls[0][1])
            condition = False
        else:
            break
